...
class CoatNet(nn.Module):
    def __init__(self,Pretrained_Model):
        ...
        self.lin2=nn.Linear(in_features=1024,out_features=20,bias=True)
        self.norm_o1=LayerNorm2d((512,), eps=1e-06)
        self.norm_o2=LayerNorm2d((1024,), eps=1e-06)
        
        self.Transformer1=nn.Sequential(
        self.model.stages[2].blocks[7],
        self.model.stages[2].blocks[8],
        self.model.stages[2].blocks[9])
        
        self.Transformer2=nn.Sequential(
            self.model.stages[3].blocks[0],
            self.model.stages[3].blocks[1],
        )
    ...
    def forward(self,x):
        ...
        out2=self.Transformer2(x)
        out2=self.norm_o2(out2)
...
checkpoint = torch.load("/home/22mces01/Hierarchical_CoatNetV3/Hierarchical_CoatNet_Best_BESTMODEL.pth.tar")
