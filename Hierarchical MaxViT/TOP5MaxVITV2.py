...
class MaxVit(nn.Module):
    def __init__(self,Pretrained_Model):
        ...
        self.lin1=nn.Linear(in_features=128,out_features=6,bias=True)
        self.lin2=nn.Linear(in_features=256,out_features=20,bias=True)
        self.norm_o1=LayerNorm2d((128,), eps=1e-06)
...
checkpoint = torch.load("/home/22mces01/MaxVit_224/MaxVit_Herarchical/Hierarchical_CoatNet_Best_BESTMODEL.pth.tar")
